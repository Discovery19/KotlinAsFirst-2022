...
class Tests {
    ...
    fun containsIn() {
        ...
        assertFalse(containsIn(mapOf("b" to "z", "a" to "beee"), mapOf("a" to "z", "b" to "beee")))
    }
    ...
    fun findSumOfTwo() {
        ...
        assertEquals(
            Pair(-1, -1),
            findSumOfTwo(listOf(1, 1, 1, 0, 1, 1), 0)
        )
        assertEquals(
            Pair(-1, -1),
    ...
    fun bagPacking() {
        ...
        assertEquals(
            setOf("Слиток"),
            bagPacking(
                mapOf("Кубок" to (1 to 1), "Слиток" to (1 to 2)),
                1
            )
        )
        assertEquals(
            setOf("Кубок", "Слиток"),
            bagPacking(
                mapOf("Кубок" to (1 to 3), "Слиток" to (1 to 0)),
                2
            )
        )
    }
