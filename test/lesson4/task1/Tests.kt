...
class Tests {
    ...
    @Tag("7")
    fun russian() {
        assertEquals("пятьсот двадцать девять тысяч шестьсот двенадцать", russian(529612))
        assertEquals("триста пятьдесят тысяч восемьсот семьдесят семь", russian(350877))
